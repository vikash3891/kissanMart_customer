...
import 'features/categoriesScreen.dart';
import 'features/home.dart';
import 'features/orders/orders.dart';
import 'features/products/productDetails.dart';
import 'features/products/productListScreen.dart';
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: [
          ...
          NavigationDestination(
            icon: Badge(
              label: Text('${appState.itemCount}'),
              isLabelVisible: appState.itemCount > 0,
...
class PromoBanner extends StatelessWidget { const PromoBanner({super.key}); @override Widget build(BuildContext context) => Container(
  ...
  child: const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
    ...
    SizedBox(height: 8),
    Text('Fresh organic staples', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w900)),
